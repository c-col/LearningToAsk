...
| DeepSeek R1 Distill Qwen 7B (MKA) | contrast_sets_8_things.json | high | Simon |
...
| DeepSeek R1 Distill Qwen 14B (ZNU) | contrast_sets_8_things.json | high | Simon |
...
| DeepSeek R1 Distill Qwen 32B (LDR) | contrast_sets_8_things.json | high | Simon |
